...
class Agms
{
    ...
    /**
     * Get Delete Card Data from SAFE
     * @param $params
     * @return string
     */
    ...
    /**
     * Get Query Card Data from SAFE
     * @param $params
     * @return string
     */
    public static function querySafe($params)
    {
